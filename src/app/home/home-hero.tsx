...
let showlist = [
  ...
  { id: "286801", media_type: "tv" },
  { id: "120089", media_type: "tv" },
  { id: "508947", media_type: "movie" },
  { id: "228689", media_type: "tv" },
  { id: "1236470", media_type: "movie" },
            ...
            >
              <div className="absolute  w-[calc(100%-40px)] lg:w-1/2 bottom-15 left-5 lg:left-20 z-10 text-white   flex-col  hidden lg:flex">
                ...
                <div className="mt-5 space-x-2">
                  <Button
                    asChild
                    className="bg-red-950/50 hover:bg-zinc-900 border-red-700 border-1 text-white"
                  >
                    <Link
